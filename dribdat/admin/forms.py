...
class EventForm(FlaskForm):
    ...
    lock_resources = BooleanField(u'Recommend projects globally (Resources)', default=False, description=u'* When enabled, the start and finish dates are ignored.')
    ...
    summary = StringField(u'Summary', [length(max=140)], description=u'A brief description for the upcoming events page')
    description = TextAreaField(u'Description', description=u'Markdown and HTML supported')
    instruction = TextAreaField(u'Instructions', description=u'Shown to participants on the main event page, Markdown and HTML supported')
